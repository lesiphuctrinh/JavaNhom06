...
/**
 * Servlet implementation class capnhatLoaiController
 */
@WebServlet("/capnhatLoaiController")
public class capnhatLoaiController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public capnhatLoaiController() {
        super();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            ...
            try {
             ...
             // Kiểm tra nếu maLoai và tenLoai không phải là null hoặc trống
                if (maLoai == null || maLoai.trim().isEmpty()) {
                    ...
                    RequestDispatcher rd = request.getRequestDispatcher("CapNhatLoai.jsp");
                ...
                // Gọi business logic để thêm loại
                LoaiBO lBo = new LoaiBO();
                isSuccess = lBo.capNhatLoai(maLoai, tenLoai);
        ...
        if (isSuccess) {
            ...
            RequestDispatcher dispatcher = request.getRequestDispatcher("CapNhatLoai.jsp");
