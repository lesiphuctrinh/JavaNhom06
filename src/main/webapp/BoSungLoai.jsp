    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
				...
				<h2 class="mb-4">Bổ Sung Thông Tin Loại</h2>
				<!-- Hiển thị thông báo -->
	        ...
	        <% } %>
        <form method="post" enctype="multipart/form-data" action="bosungLoaiController">
            
			<!-- Mã loại -->
            <div class="mb-3">
                <label class="form-label">Mã Loại</label>
                <input type="text" class="form-control" name="maLoai" placeholder="Nhập mã loại" required>
            </div>
            
            <!-- Tên loại -->
            <div class="mb-3">
                <label class="form-label">Tên Loại</label>
                <input type="text" class="form-control" name="tenLoai" placeholder="Nhập tên loại" required>
            </div>
