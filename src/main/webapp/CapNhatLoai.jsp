    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
				...
				<h2 class="mb-4">Cập Nhật Thông Tin Loại</h2>
				<!-- Hiển thị thông báo -->
	        ...
	        <% } %>
        <form action="capnhatLoaiController" method="post" enctype="multipart/form-data">
            
			<!-- Mã sách -->
            <div class="mb-3">
                <input type="hidden" class="form-control" id="bookName" name="maLoai" placeholder="Nhập mã loại" value="<%= request.getParameter("maLoai") %>" readonly>
            </div>
            
            <!-- Tên sách -->
            <div class="mb-3">
                <label for="bookName" class="form-label">Tên Loại</label>
                <input type="text" class="form-control" id="bookName" name="tenLoai" placeholder="Nhập tên loại" required>
            </div>

            <div class="d-flex justify-content-end">
			    <button type="submit" class="btn btn-primary">Lưu Thông Tin</button>
			    <a href="loaiAdminController" class="btn btn-secondary" style="margin-left: 15px;">Quay lại</a>	
			</div>
        </form>
