    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
				...
				<h2 class="mb-4">Bổ Sung Thông Tin Sách</h2>
				<!-- Hiển thị thông báo -->
	        ...
	        <% } %>
        <form method="post" enctype="multipart/form-data" action="bosungSachController">
            <!-- Ảnh -->
            <div class="mb-3">
                <label for="bookImage" class="form-label">Ảnh</label>
                <input type="file" class="form-control" id="bookImage" name="anh" accept="images/*" required>
            </div>
			
			<!-- Mã sách -->
            <div class="mb-3">
                <label for="bookName" class="form-label">Mã Sách</label>
                <input type="text" class="form-control" id="bookName" name="maSach" placeholder="Nhập mã sách" required>
            </div>
